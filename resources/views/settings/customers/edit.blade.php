            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('customers.update', $customer) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('customer_type') is-invalid @enderror" id="customer_type" name="customer_type">
                                        <option value="">Seçiniz</option>
                                        <option value="individual" {{ old('customer_type', $customer->customer_type) == 'individual' ? 'selected' : '' }}>Bireysel</option>
                                        <option value="corporate" {{ old('customer_type', $customer->customer_type) == 'corporate' ? 'selected' : '' }}>Kurumsal</option>
                                    </select>
                                    @error('customer_type')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="row" id="corporateFields" style="display: {{ old('customer_type', $customer->customer_type) == 'corporate' ? 'flex' : 'none' }};">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tax_office') is-invalid @enderror" id="tax_office" name="tax_office" value="{{ old('tax_office', $customer->tax_office) }}">
                                    @error('tax_office')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    .then(result => {
                        if (result.success && Array.isArray(result.data)) {
                            result.data.forEach(district => {
                                ...
                                if (district.id == '{{ old('district_id', $customer->district_id) }}') {
